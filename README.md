...
マウス操作を中心に、12ステージキャンペーン、8種アイテム、コンボ、評価、サウンド、開始前設定を備えています。
...
- ドロップ率 `18%`、同時落下上限 `3`
- 種類: `paddle_plus`, `slow_ball`, `multiball`, `shield`, `pierce`, `bomb`, `laser`, `sticky`
...
- デバッグモードのアイテムプリセット:
  ...
  - ボス確認: `shield=2, pierce=1, bomb=1, laser=2, sticky=1`（新アイテムスタックOFF時は `laser=1`）
