...
export const ITEM_REGISTRY: ItemRegistry = {
  ...
  decoy: {
    type: "decoy",
    stackKey: "decoyStacks",
    label: ITEM_CONFIG.decoy.label,
    icon: "🎯",
    hudLabel: "🎯デコイ",
    emoji: "🎯",
    description: "敵弾を引きつけるデコイを展開",
    shortLabel: "囮",
    color: "rgba(255, 206, 148, 0.92)",
    weight: ITEM_CONFIG.decoy.weight,
    maxStacks: 1,
    dropSuppressedWhenActive: false,
    hudOrder: 9,
    ...
    encounterBias: "boss",
    sfxEvent: "item_decoy",
    presentation: createPresentation({ flashMs: 100, auraMs: 760, shakePx: 2.2 }),
    applyPickup: noImpact(({ stacks }) => {
      stacks.decoyStacks = 1;
    }),
    getLabelStack: (stacks) => stacks.decoyStacks,
  },
  laser: {
    type: "laser",
